				...
				"paths" => array (
						"/boards/message" => array (
								"get" => array (
										...
										"summary" => "取得留言(分頁)",
										"description" => "網頁角度取得留言<br/>必填(節目編號  或  影音類習型+影音編號)",
										"parameters" => array (
												array (
														"name" => "programme",
														"description" => "節目編號",
												...
												array (
														"name" => "sort",
														"description" => "排序[1:舊到新,0:新到舊(資料庫)]",
														"in" => "query",
														"type" => "integer" 
												),
												array (
						...
						"/boards/message_reply" => array (
								"get" => array (
										"tags" => array (
												"1.boards" 
										),
										"summary" => "取得留言(分頁)+回應",
										"description" => "取得留言(分頁)+回應",
										"parameters" => array (
												array (
														"name" => "programme",
														"description" => "節目編號",
												...
												"200" => array (
														...
														"schema" => array (
																...
																"properties" => array (
																		...
																		"info" => $this->__get_responses_data ( "page info" ),
																		"data" => $this->__get_responses_data ( "replys data" ) 
																) 
														) 
												),
												"204" => array (
